function [blurry,horizontal,vertical,diagonal] = db2(x,Lo_D,Hi_D)
%db2 Daubechies wavelet transformation for 2D structures:
...
%   while blurry contains the structure.
    ...
    for i=1:r
        [row_low(i,:), row_high(i,:)] = ...
            discreteWaveletTransform(x(i,:), Lo_D, Hi_D);
    end
    ...
    % inverse
    for i=1:c/2
        [blurry(:,i), horizontal(:,i)] = ...
            discreteWaveletTransform(row_low(:,i), Lo_D, Hi_D);
        [vertical(:,i), diagonal(:,i)] = ...
            discreteWaveletTransform(row_high(:,i), Lo_D, Hi_D);
    end
end